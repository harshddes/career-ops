% FROZEN content draft — do not keep editing.
% This was merged into HarshDesai_Terafab_PlasmaSystems_Resume.tex (the file that was actually compiled).
% Living source is harsh/resume/HarshDesai_Resume.tex
