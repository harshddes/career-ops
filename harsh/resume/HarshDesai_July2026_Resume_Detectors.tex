% Compile with:
%   node generate-latex.mjs harsh/resume/HarshDesai_July2026_Resume_Detectors.tex harsh/resume/HarshDesai_July2026_Resume_UW-IDP_Mechanical-Instrumentation_v6.pdf
% Living source. Never overwrite an existing PDF — always use a new relevant name.
