...
%   xelatex HarshDesai_Terafab_PlasmaSystems_Resume.tex
% Formatting: HarshDesaiResume.tex | Content: Harsh_Desai_Terafab_Resume.tex
% Distinctive name: Terafab-targeted plasma / process-equipment resume (A4 perfect-format shell)
